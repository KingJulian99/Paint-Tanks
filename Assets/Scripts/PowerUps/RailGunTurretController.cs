...
public class RailGunTurretController : MonoBehaviour
{
    /*
    ...
    */
    ...
    void Start()
    {
        this.barrel = this.gameObject.transform.Find("Railgun").gameObject;
    ...
    void Shoot() {
        ...
        // set bullet damage
        shot.GetComponent<BulletController>().damage = 70;

        // Set paint radius
        shot.GetComponent<BulletController>().radius *= 1.2f;
    }
    ...
    private void SpawnTurret(GameObject tank)
    {
        ...
        GameObject turret = tank.transform.Find("RailGun").gameObject;
