...
public class GamepadGatlingTurretController : MonoBehaviour
{
    /*
    ...
    */
    ...
    public void Shoot(InputAction.CallbackContext ctx) {
        ...
        if(canShoot) {
            ...
            shot.transform.localScale = projectile.transform.localScale * 0.5f;
    ...
    private void SpawnTurret(GameObject tank)
    {
        ...
        GameObject turret = tank.transform.Find("GamepadGatlingTurret").gameObject;
